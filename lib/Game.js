...
function Game() {
    ...
    Game.prototype.checkEndOfBattle = function () {
        ...
        if (this.player.isAlive() && this.currentEnemy.isAlive()) {
            ...
            console.log(`${this.player.name} found a potion of ${this.currentEnemy.potion.name}!`);
            ...
            if (this.roundNumber < this.enemies.length) {
                ...
                console.log('You have slayed all of the monsters... who is the monster now?');
            }
        } else {
            console.log("The hordes of darkness slaughtered you...");
        }
    };
};
